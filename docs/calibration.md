...
- **The shape of an entry is worth trusting where a judgement was made, but it is not
  ...
  and 94 measured. The tools agree on 183 by convention, and the convention undercounts by one. 129 name the rivals the
  ...
  the 93 `measured` entries name no rival at all, and 13 of those state no promotion criterion
...
disagree. Of the 183 top-level keys with a status, 93 are `measured`; a 184th entry nested inside another is measured too.
