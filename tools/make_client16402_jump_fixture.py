...
def build() -> dict:
    ...
    return {
        "$comment": "GENERATED by tools/make_client16402_jump_fixture.py from live capture " + capture +
                    " (client 16.402); do not edit by hand. Native millitiles, absolute; nodes goal first as "
                    "published; state 5 is the hop, 1 the walk; ticks the capture does not carry are absent.",
        "capture": capture,
